...
It is the structure or skeleton of the web page.


2. Name two big differences between ```display: block;``` and ```display: inline;```.
It is the default behavior of the div, it is displayed as its name indicates it in vertical, while inline is horizontal

3. What are the 4 areas of the box model?
margin,padding,border,content

4. While using flexbox, what axis does the following property work on: ```align-items: center```?
You will align the cross axis elements in the center
5. Explain why git is valuable to a team of developers.
It helps to keep track of web development, maintains a chronological order and is very easy to use.
